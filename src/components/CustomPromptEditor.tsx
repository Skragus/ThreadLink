...
export const CustomPromptEditor: React.FC<CustomPromptEditorProps> = ({
  ...
  const handleApplyAndClose = () => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">      <div className="bg-[var(--card-bg)] border border-red-500/50 rounded-lg w-full max-w-4xl h-[95vh] sm:h-[90vh] flex flex-col">
        
        {/* Header */}
        <div className="border-b border-red-500/30 p-3 sm:p-4 bg-red-950/20 flex-shrink-0">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-red-900/20 border border-red-500/30 rounded p-2 sm:p-3">              
        ...
        <div className="flex-1 p-3 sm:p-4 min-h-0">
          <textarea
            ...
            className="w-full h-full p-3 sm:p-4 bg-[var(--bg-primary)] border border-[var(--divider)] rounded text-[var(--text-primary)] font-mono text-xs sm:text-sm resize-none focus:outline-none focus:border-red-500/50"
            placeholder="Enter your custom prompt..."
            spellCheck={false}
          />
        </div>        {/* Footer */}
        <div className="border-t border-red-500/30 p-3 sm:p-4 bg-red-950/10 flex-shrink-0">
