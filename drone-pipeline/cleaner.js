 ...
 */
const { estimateTokens } = require('./utils'); // Import from utils.js
...
function cleanAiChatContent(content) {
    ...
    console.log(`📊 Token count: ${originalTokens.toLocaleString()} → ${cleanedTokens.toLocaleString()} tokens (saved ${tokensSaved.toLocaleString()} tokens, ${percentSaved}%)`);
